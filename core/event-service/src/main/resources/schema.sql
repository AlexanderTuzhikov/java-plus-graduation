...
(
    ...
    CONSTRAINT fk_compevents_to_compilations
        FOREIGN KEY (compilation_id)
            REFERENCES compilations (id)
            ON DELETE CASCADE,

    CONSTRAINT fk_compevents_to_events
        FOREIGN KEY (event_id)
            REFERENCES events (id)
            ON DELETE SET NULL
);

CREATE INDEX IF NOT EXISTS idx_event_state
    ON events (state);

CREATE INDEX IF NOT EXISTS idx_event_category
    ON events (category_id);

CREATE INDEX IF NOT EXISTS idx_event_initiator
