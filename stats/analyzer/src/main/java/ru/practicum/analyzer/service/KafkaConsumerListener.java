...
public class KafkaConsumerListener {
    ...
    @KafkaListener(topics = "${kafka.topics.user-actions}", groupId = "${spring.kafka.analyzer.consumers.user-action.group-id}")
    ...
    @KafkaListener(topics = "${kafka.topics.events-similarity}", groupId = "${spring.kafka.analyzer.consumers.event-similarity.group-id}")
