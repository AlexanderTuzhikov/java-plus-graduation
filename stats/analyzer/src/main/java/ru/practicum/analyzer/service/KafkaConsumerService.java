        ...
        try {
            ...
            if (existingAction == null) {
                UserAction newAction = UserAction.builder()
                        ...
                        .lastActionTime(LocalDateTime.ofInstant(action.getTimestamp(), ZoneId.systemDefault()))
                        .build();
                ...
                existingAction.setLastActionTime(LocalDateTime.ofInstant(action.getTimestamp(), ZoneId.systemDefault()));
        ...
        try {
            ...
            if (existingSimilarity == null) {
                EventSimilarity newSimilarity = EventSimilarity.builder()
                        ...
                        .eventB(eventB)
                        .score(score)
                        .updated(LocalDateTime.ofInstant(similarity.getTimestamp(), ZoneId.systemDefault()))
                        .build();
                ...
                existingSimilarity.setUpdated(LocalDateTime.ofInstant(similarity.getTimestamp(), ZoneId.systemDefault()));
